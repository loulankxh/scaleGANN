...
void testOurDesign(){
    ...
    std::string index_file = "/home/lanlu/raft/scaleGANN/dataset/sift100M/partitions21deg-20shards/mergedIndex/raft_cagra.graph_degree21.intermediate_graph_degree21.graph_build_algoNN_DESCENT";
