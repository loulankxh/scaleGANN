...
2. Run index construction (the time of each step will show in the last line of terminal output)
   ...
   ```
3. Search: build/searchScaleGANN
## Run DiskANN
...
2. Run index construction (the time of each step will show in the last line of terminal output) 
   ...
   ```
4. Search: build/searchDiskANN
## Run GGNN and Naive CAGRA
1. Compile the ScaleGANN repo to get the build folder and files
2. Run index construction (the time of each step will show in the last line of terminal output)
   a. Partition (if necessary): build/executeDiskDirectPartition
   b. Build: Run [apps/buildGGNN.sh](https://github.com/loulankxh/scaleGANN/blob/main/apps/buildGGNN.sh) for GGNN build. For Naive CAGRA build, take ScaleGANN build for reference.
3. Search: build/searchGGNN, or build/searchCAGRA
...
Build data with details are in folder [experiments](https://github.com/loulankxh/scaleGANN/tree/main/experiments).
## Search experiments
...
For more details, also see in folder [experiments](https://github.com/loulankxh/scaleGANN/tree/main/experiments).
